...
%% Explore horizons space with lmpc
...
for jjj = 1:noises_number
    ...
    close all;
    mean(mink(rmses{k}(:),10)) % For numerical results given in the paper without complete heatmaps
    ...
    close all;
    mean(mink(rmses_total(:),10)) % For numerical results given in the paper without complete heatmaps
